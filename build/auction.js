...
var Product = /** @class */ (function () {
    function Product(id, title, price, rating, desc, summary, category) {
        this.id = id;
        this.title = title;
        this.price = price;
        this.rating = rating;
...
app.get('/api/product/:id/comment', function (Request, Response) {
    Response.json(comments.filter(function (comment) { return comment.productId == Request.params.id; }));
